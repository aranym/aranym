...
GLAPI void APIENTRY glTexPageCommitmentARB(GLenum target, GLint level, GLint xoffset, GLint yoffset, GLint zoffset, GLsizei width, GLsizei height, GLsizei depth, GLboolean32 resident);
...
GLAPI void APIENTRY glTexturePageCommitmentEXT(GLuint texture, GLint level, GLint xoffset, GLint yoffset, GLint zoffset, GLsizei width, GLsizei height, GLsizei depth, GLboolean32 resident);
...
GLAPI void APIENTRY glVertex2bOES(GLbyte32 x);
...
GLAPI void APIENTRY glVertex3bOES(GLbyte32 x, GLbyte32 y);
...
GLAPI void APIENTRY glVertex4bOES(GLbyte32 x, GLbyte32 y, GLbyte32 z);
