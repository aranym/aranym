...
GLAPI void APIENTRY glShadingRateImageBarrierNV(GLboolean32 synchronize);
...
GLAPI GLvdpauSurfaceNV APIENTRY glVDPAURegisterVideoSurfaceWithPictureStructureNV(const void *vdpSurface, GLenum target, GLsizei numTextureNames, const GLuint *textureNames, GLboolean32 isFrameStructure);
...
/* Functions generated: 13 OSMesa + 2955 GL + 1 GLU */
