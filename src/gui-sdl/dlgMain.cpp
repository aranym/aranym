...
SGOBJ maindlg[] =
{
  ...
  { SGBUTTON, SG_EXIT, 0, 4,8, 14,1, "Hotkeys" },
  { SGBUTTON, SG_EXIT, 0, 4,10, 14,1, "Keyboard" },
  { SGBUTTON, SG_EXIT, 0, 4,12, 14,1, "TOS" },
  { SGBUTTON, SG_EXIT, 0, 22,4, 14,1, "Video" },
  { SGBUTTON, SG_EXIT, 0, 22,6, 14,1, "JIT CPU" },
  { SGBUTTON, SG_EXIT, 0, 22,8, 14,1, "Host FS" },
  { SGBUTTON, SG_EXIT, 0, 22,10, 14,1, "Host CD/DVD" },
  { SGBUTTON, SG_EXIT, 0, 22,12, 14,1, "Input/Output" },
  { SGBUTTON, SG_EXIT, 0, 7,15, 26,1, "Apply changed settings" },
  { SGTEXT, 0, 0, 4,18, 10,1, "ARAnyM:" },
  { SGBUTTON, SG_EXIT, 0, 2,20, 10,1, "Reboot" },
  { SGBUTTON, SG_EXIT, 0, 2,22, 10,1, "Shutdown" },
  { SGTEXT, 0, 0, 17,18, 7,1, "Config:" },
  { SGBUTTON, SG_EXIT, 0, 17,20, 7,1, "Load" },
  { SGBUTTON, SG_EXIT, 0, 17,22, 7,1, "Save" },
  { SGBUTTON, SG_EXIT|SG_DEFAULT, 0, 30,22, 8,1, "Close" },
  { -1, 0, 0, 0,0, 0,0, NULL }
};
