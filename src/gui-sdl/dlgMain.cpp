...
SGOBJ maindlg[] = {
	...
	{SGBOX, 0, 0, 19, 2, 38, 15, NULL},
	{SGTEXT, 0, 0, 32, 1, 14, 1, " ARAnyM SETUP "},
	{SGBUTTON, SG_SELECTABLE|SG_EXIT, 0, 20, 3, 17, 1, "About"},
	{SGBUTTON, SG_SELECTABLE|SG_EXIT, 0, 20, 5, 17, 1, "Disks"},
	{SGBUTTON, SG_SELECTABLE|SG_EXIT, 0, 20, 7, 17, 1, "Hotkeys"},
	{SGBUTTON, SG_SELECTABLE|SG_EXIT, 0, 20, 9, 17, 1, "Keyboard + mouse"},
	{SGBUTTON, SG_SELECTABLE|SG_EXIT, 0, 20, 11, 17, 1, "Operating System"},
	{SGBUTTON, SG_SELECTABLE|SG_EXIT, 0, 39, 3, 17, 1, "Video"},
	{SGBUTTON, SG_SELECTABLE|SG_EXIT, 0, 39, 5, 17, 1, "Networking"},
	...
	{SGBOX, 0, 0, 19, 19, 38, 5, NULL},
	{SGTEXT, 0, 0, 27, 18, 22, 1, " Quick Access Buttons "},
	{SGBUTTON, SG_SELECTABLE|SG_EXIT, 0, 21, 20, 10, 1, "Reboot"},
	{SGBUTTON, SG_SELECTABLE|SG_EXIT, 0, 21, 22, 10, 1, "Shutdown"},
	{SGBUTTON, SG_SELECTABLE|SG_EXIT, 0, 33, 20, 12, 1, "Fullscreen"},
	{SGBUTTON, SG_SELECTABLE|SG_EXIT, 0, 33, 22, 12, 1, "Screenshot"},
	{SGBUTTON, SG_SELECTABLE|SG_EXIT, 0, 47, 20, 8, 1, "Help"},
	{SGBUTTON, SG_SELECTABLE|SG_EXIT|SG_DEFAULT, 0, 47, 22, 8, 1, "Close"},
	{-1, 0, 0, 0, 0, 0, 0, NULL}
};
