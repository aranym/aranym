/**
  ...
  Notes: 2001 STanda
	...
	The filenames of the library files were changed from SDL_gfxPrimitives*
		to gfxprimitives* to become compatible with the ARAnyM source filename
		convetions.
	The USE_CHARACTER_FUNCTIONS were added to avoid the need of the _font.h
	file. This library will be most probably changed to satisfy the needs
	of the VDI driver beeing written in fvdidrv.cpp
**/
...
#undef USE_CHARACTER_FUNCTIONS
#ifdef USE_CHARACTER_FUNCTIONS
#include "gfxprimitives_font.h"
#endif

/* -===================- */

/* STanda brutal HACK to get this lib patterns aware FIXME!!! */
/* as a consequence this lib looses much from possible thread
   safety, SDL is not thread safe either so I don't care for now */
unsigned short *areaPattern = NULL;
