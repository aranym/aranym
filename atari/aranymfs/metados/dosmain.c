...
extern void initfun ();
extern void fs_dfree ();
extern void fs_fsfirst ();
extern void fs_fsnext ();
extern void fs_fopen ();
extern void fs_fclose ();
extern void fs_fdatime ();
extern void fs_fread ();
extern void fs_fwrite ();
extern void fs_fattrib ();
extern void fs_dcreate ();
extern void fs_ddelete ();
extern void fs_frename ();
extern void fs_fcreate ();
extern void fs_fseek ();
extern void fs_fcntl ();
extern void fs_dpathconf ();
extern void fs_dopendir ();
extern void fs_dreaddir ();
extern void fs_dgetpath ();
extern void fs_dsetpath ();
extern void fs_dxreaddir ();
extern void fs_dclosedir ();
extern void fs_drewinddir ();
extern void fs_fxattr ();
extern void fs_dreadlabel ();
...
long FunctionTable[] =
{
	(long) 0x4d414749L /* 'MAGI' */, (long) 0x434d4554L /* 'CMET' */, 349,
	(long) initfun,
	-1L, -1L, -1L, -1L, -1L,
	-1L, -1L, -1L, -1L, -1L,
	-1L, -1L, -1L, -1L, -1L,
...
void* _cdecl InitDevice( int deviceid )
{
	LOGICAL_DEV *ldp;

	(void)deviceid;

	ldp = (LOGICAL_DEV *)Malloc (sizeof (LOGICAL_DEV));
	if (!ldp) {
...
/**
 * $Log$
 * Revision 1.4  2002/04/04 19:12:43  standa
 * Pretty print.
 *
