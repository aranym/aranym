...
#undef gluLookAt
	...
	glp->DisableClientState = (void APIENTRY (*)(GLenum cap)) ldg_find("glDisableClientState", lib);
	GL_CHECK(glp->DisableClientState);
	glp->EnableClientState = (void APIENTRY (*)(GLenum cap)) ldg_find("glEnableClientState", lib);
	...
	glp->NormalPointer = (void APIENTRY (*)(GLenum type, GLsizei stride, const GLvoid *ptr)) ldg_find("glNormalPointer", lib);
	...
	glp->TexCoordPointer = (void APIENTRY (*)(GLint size, GLenum type, GLsizei stride, const GLvoid *ptr)) ldg_find("glTexCoordPointer", lib);
	...
	glp->VertexPointer = (void APIENTRY (*)(GLint size, GLenum type, GLsizei stride, const GLvoid *ptr)) ldg_find("glVertexPointer", lib);
