...
#undef gluLookAt
	...
	glp->DepthRange = (void APIENTRY (*)(GLclampd near_val, GLclampd far_val)) ldg_find("glDepthRange", lib);
	...
	glp->Ortho = (void APIENTRY (*)(GLdouble left, GLdouble right, GLdouble bottom, GLdouble top, GLdouble near_val, GLdouble far_val)) ldg_find("glOrthod", lib);
	GL_CHECK(glp->Ortho);
	glp->Frustum = (void APIENTRY (*)(GLdouble left, GLdouble right, GLdouble bottom, GLdouble top, GLdouble near_val, GLdouble far_val)) ldg_find("glFrustumd", lib);
	...
	glp->IndexPointer = (void APIENTRY (*)(GLenum type, GLsizei stride, const GLvoid *ptr)) ldg_find("glIndexPointer", lib);
	...
	glp->EdgeFlagPointer = (void APIENTRY (*)(GLsizei stride, const GLvoid *ptr)) ldg_find("glEdgeFlagPointer", lib);
	...
	glp->BindShadingRateImageNV = (void APIENTRY (*)(GLuint texture)) ldg_find("glBindShadingRateImageNV", lib);
	GL_CHECK(glp->BindShadingRateImageNV);
	glp->GetShadingRateImagePaletteNV = (void APIENTRY (*)(GLuint viewport, GLuint entry, GLenum *rate)) ldg_find("glGetShadingRateImagePaletteNV", lib);
	GL_CHECK(glp->GetShadingRateImagePaletteNV);
	glp->GetShadingRateSampleLocationivNV = (void APIENTRY (*)(GLenum rate, GLuint samples, GLuint index, GLint *location)) ldg_find("glGetShadingRateSampleLocationivNV", lib);
	GL_CHECK(glp->GetShadingRateSampleLocationivNV);
	glp->ShadingRateImageBarrierNV = (void APIENTRY (*)(GLboolean32 synchronize)) ldg_find("glShadingRateImageBarrierNV", lib);
	GL_CHECK(glp->ShadingRateImageBarrierNV);
	glp->ShadingRateImagePaletteNV = (void APIENTRY (*)(GLuint viewport, GLuint first, GLsizei count, const GLenum *rates)) ldg_find("glShadingRateImagePaletteNV", lib);
	GL_CHECK(glp->ShadingRateImagePaletteNV);
	glp->ShadingRateSampleOrderCustomNV = (void APIENTRY (*)(GLenum rate, GLuint samples, const GLint *locations)) ldg_find("glShadingRateSampleOrderCustomNV", lib);
	GL_CHECK(glp->ShadingRateSampleOrderCustomNV);
	glp->ShadingRateSampleOrderNV = (void APIENTRY (*)(GLenum order)) ldg_find("glShadingRateSampleOrderNV", lib);
	GL_CHECK(glp->ShadingRateSampleOrderNV);
	glp->GetMemoryObjectDetachedResourcesuivNV = (void APIENTRY (*)(GLuint memory, GLenum pname, GLint first, GLsizei count, GLuint *params)) ldg_find("glGetMemoryObjectDetachedResourcesuivNV", lib);
	GL_CHECK(glp->GetMemoryObjectDetachedResourcesuivNV);
	glp->ResetMemoryObjectParameterNV = (void APIENTRY (*)(GLuint memory, GLenum pname)) ldg_find("glResetMemoryObjectParameterNV", lib);
	GL_CHECK(glp->ResetMemoryObjectParameterNV);
	glp->TexAttachMemoryNV = (void APIENTRY (*)(GLenum target, GLuint memory, GLuint64 offset)) ldg_find("glTexAttachMemoryNV", lib);
	GL_CHECK(glp->TexAttachMemoryNV);
	glp->BufferAttachMemoryNV = (void APIENTRY (*)(GLenum target, GLuint memory, GLuint64 offset)) ldg_find("glBufferAttachMemoryNV", lib);
	GL_CHECK(glp->BufferAttachMemoryNV);
	glp->TextureAttachMemoryNV = (void APIENTRY (*)(GLuint texture, GLuint memory, GLuint64 offset)) ldg_find("glTextureAttachMemoryNV", lib);
	GL_CHECK(glp->TextureAttachMemoryNV);
	glp->NamedBufferAttachMemoryNV = (void APIENTRY (*)(GLuint buffer, GLuint memory, GLuint64 offset)) ldg_find("glNamedBufferAttachMemoryNV", lib);
	GL_CHECK(glp->NamedBufferAttachMemoryNV);
	glp->DrawMeshTasksNV = (void APIENTRY (*)(GLuint first, GLuint count)) ldg_find("glDrawMeshTasksNV", lib);
	GL_CHECK(glp->DrawMeshTasksNV);
	glp->DrawMeshTasksIndirectNV = (void APIENTRY (*)(GLintptr indirect)) ldg_find("glDrawMeshTasksIndirectNV", lib);
	GL_CHECK(glp->DrawMeshTasksIndirectNV);
	glp->MultiDrawMeshTasksIndirectCountNV = (void APIENTRY (*)(GLintptr indirect, GLintptr drawcount, GLsizei maxdrawcount, GLsizei stride)) ldg_find("glMultiDrawMeshTasksIndirectCountNV", lib);
	GL_CHECK(glp->MultiDrawMeshTasksIndirectCountNV);
	glp->MultiDrawMeshTasksIndirectNV = (void APIENTRY (*)(GLintptr indirect, GLsizei drawcount, GLsizei stride)) ldg_find("glMultiDrawMeshTasksIndirectNV", lib);
	GL_CHECK(glp->MultiDrawMeshTasksIndirectNV);
	glp->EGLImageTargetTexStorageEXT = (void APIENTRY (*)(GLenum target, GLeglImageOES image, const GLint *attrib_list)) ldg_find("glEGLImageTargetTexStorageEXT", lib);
	GL_CHECK(glp->EGLImageTargetTexStorageEXT);
	glp->EGLImageTargetTextureStorageEXT = (void APIENTRY (*)(GLuint texture, GLeglImageOES image, const GLint *attrib_list)) ldg_find("glEGLImageTargetTextureStorageEXT", lib);
	GL_CHECK(glp->EGLImageTargetTextureStorageEXT);
	glp->FramebufferFetchBarrierEXT = (void APIENTRY (*)(void)) ldg_find("glFramebufferFetchBarrierEXT", lib);
	GL_CHECK(glp->FramebufferFetchBarrierEXT);
	glp->NamedRenderbufferStorageMultisampleAdvancedAMD = (void APIENTRY (*)(GLuint renderbuffer, GLsizei samples, GLsizei storageSamples, GLenum internalformat, GLsizei width, GLsizei height)) ldg_find("glNamedRenderbufferStorageMultisampleAdvancedAMD", lib);
	GL_CHECK(glp->NamedRenderbufferStorageMultisampleAdvancedAMD);
	glp->RenderbufferStorageMultisampleAdvancedAMD = (void APIENTRY (*)(GLenum target, GLsizei samples, GLsizei storageSamples, GLenum internalformat, GLsizei width, GLsizei height)) ldg_find("glRenderbufferStorageMultisampleAdvancedAMD", lib);
	GL_CHECK(glp->RenderbufferStorageMultisampleAdvancedAMD);
	glp->ScissorExclusiveArrayvNV = (void APIENTRY (*)(GLuint first, GLsizei count, const GLint *v)) ldg_find("glScissorExclusiveArrayvNV", lib);
	GL_CHECK(glp->ScissorExclusiveArrayvNV);
	glp->ScissorExclusiveNV = (void APIENTRY (*)(GLint x, GLint y, GLsizei width, GLsizei height)) ldg_find("glScissorExclusiveNV", lib);
	GL_CHECK(glp->ScissorExclusiveNV);
	glp->VDPAURegisterVideoSurfaceWithPictureStructureNV = (GLvdpauSurfaceNV APIENTRY (*)(const void *vdpSurface, GLenum target, GLsizei numTextureNames, const GLuint *textureNames, GLboolean32 isFrameStructure)) ldg_find("glVDPAURegisterVideoSurfaceWithPictureStructureNV", lib);
	GL_CHECK(glp->VDPAURegisterVideoSurfaceWithPictureStructureNV);
	gl.__numfuncs = 3059;
